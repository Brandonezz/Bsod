...
public class EditingScreen extends Sprite {
    ...
    public function EditingScreen() {
        ...
        this.returnButton_ = new TitleMenuOption("Back to Home Screen", 25, true);
        this.returnButton_.setColor(0xFF00FF);
        this.returnButton_.setAutoSize(TextFieldAutoSize.RIGHT);
        this.returnButton_.x = ((this.chooserDrowDown_.x + this.chooserDrowDown_.width) - 7);
        this.returnButton_.y = 30;
