...
public class Options extends Sprite {
    ...
    private static const TABS:Vector.<String> = new <String>[TextKey.OPTIONS_CONTROLS, TextKey.OPTIONS_HOTKEYS, TextKey.OPTIONS_CHAT, TextKey.OPTIONS_GRAPHICS, TextKey.OPTIONS_SOUND, "Extras"];
    ...
    private function addGraphicsOptions():void {
        this.addOptionAndPosition(new ChoiceOption("fullscreenMod", makeOnOffLabels(),[true, false], "Enable Mscale", "/mscale <value>", null));
        var _local_1:String;
        var _local_2:Number;
