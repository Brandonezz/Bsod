        ...
        private _ Mountain = () => Behav()
            .Init("White Demon",
                ...
                new Threshold(0.18,
                    ...
                    new ItemLoot("150 Fame", 0.05),
                    new ItemLoot("500 Fame", 0.03),
                    new ItemLoot("50 Fame", 0.02),
                    new ItemLoot("5000 Fame", 0.01),
                    new ItemLoot("5000 Gold", 0.01),
                    new ItemLoot("1000 Gold", 0.02),
                    new ItemLoot("500 Fame", 0.03),
                    new ItemLoot("150 Fame", 0.05),
                    new ItemLoot("50 Gold", 0.02),
            ...
            .Init("Medusa",
                new State(
                    ...
                    new DropPortalOnDeath("Abyss of Demons Portal", 40)
                    ),
                new TierLoot(6, ItemType.Weapon, 0.30),
                new TierLoot(7, ItemType.Weapon, 0.20),
                new TierLoot(8, ItemType.Weapon, 0.15),
                new TierLoot(9, ItemType.Weapon, 0.1),
                new TierLoot(7, ItemType.Armor, 0.30),
                new TierLoot(8, ItemType.Armor, 0.20),
