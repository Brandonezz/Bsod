                                ...
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateFame(Client.Account, 50);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("You have acquired 50 Fame!");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Fame150:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateFame(Client.Account, 150);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("You have acquired 150 Fame!");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Fame500:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateFame(Client.Account, 500);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("You have acquired 500 Fame!");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Fame1000:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                ...
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateCredit(Client.Account, 50);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("You have acquired 50 Gold!");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Gold150:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateCredit(Client.Account, 150);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("You have acquired 150 Gold!");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Gold500:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateCredit(Client.Account, 500);
                                        UpdateCount++;
                                        db.Dispose();
                                ...
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateCredit(Client.Account, 1000);
                                        UpdateCount++;
                                        db.Dispose();
                                ...
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateCredit(Client.Account, 5000);
                                        UpdateCount++;
                                        db.Dispose();
