...
namespace db
{
    public partial class Database : IDisposable
    {
        ...
        {
            "Mercury", "Brave", "Fireball", "Blueberry",
        };
        ...
        public Database(string host, string database, string user, string password)
        {
            ...
            _con = new MySqlConnection(
                String.Format("Server=127.0.0.1;Database=rotmgprod;uid=root;password=AnimeLovers69;convert zero datetime=True;",
        ...
        public bool CheckAccountInUse(Account acc, ref int? timeout)
        {
            ...
            using (MySqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    ...
                    int timeInSec = 1 - (int)(DateTime.UtcNow - lastSeen).TotalSeconds;
